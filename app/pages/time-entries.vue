    ...
    <div v-for="group in groupedEntries" :key="group.date" class="space-y-3">
      ...
      <div class="flex items-center justify-between px-2">
        ...
        <span class="text-xs font-mono text-gray-400">
          Total: <span class="text-primary-500 font-bold">{{ formatDuration(group.total) }}</span>
        </span>
      </div>
      ...
      >
        <div
          ...
          :key="entry.id"
          tabindex="0"
          class="flex items-center justify-between p-4 transition-all hover:bg-gray-50 dark:hover:bg-gray-800/50 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-primary-500/50 outline-none"
